...
<section id="contact-page">
    <div class="container">
        <div class="center">
            <h2>Напишите нам</h2>
            <br class="lead">Хотите задать вопрос, нужна дополнительная информация или у Вас есть предложение? <br/>Отправьте нам сообщение с помощью специальной формы, расположенной ниже. </br>Мы обязательно Вам ответим!</p>
        </div>
